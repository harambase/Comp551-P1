...
def train_and_predict_ionosphere():
    ...
    train_and_predict_by_k_fold(df, 'ionosphere')


def train_and_predict_haberman():
    # Read Data
    df = create_df_ionosphere("../data/haberman.data")
    train_and_predict_by_k_fold(df, 'haberman')


def train_and_predict_heart():
    # Read Data
    df = create_df_heart("../data/heart.data")
    train_and_predict_by_k_fold(df, 'heart')


def train_and_predict_by_k_fold(df, name):
    # Logistic regression
