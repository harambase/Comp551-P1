...
def data_normalized(input_array):
	return preprocessing.scale(input_array)

#input_array, output_array = data_ionosphere('/Users/tianchima/Desktop/ionosphere.data')
#feature1 = input_array[:,]

#kwargs = dict(histtype='stepfilled',  bins=50,alpha = 1)
#plt.hist(feature1, **kwargs)
#plt.show()


#print ((input_array)[1,:].shape)
