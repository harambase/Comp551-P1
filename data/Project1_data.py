...
def data_adult(data_path_adult, whether_One_hot_coding):
    ...
    long_list = [list_workclass, list_education, list_maritalstatus, list_occupation, list_relationship, list_race,
                 list_sex, list_ativecountry]
    new_a = []
    for i in range(len(a)):
        if len(a[i]) == 15:
...
def split_into_train_test(input_array, output_array):
    ...
    return total_array[:number_train_set, :][:, :-1], total_array[:number_train_set, :][:, -1], total_array[
                                                                                                number_train_set:, :][:,
                                                                                                :-1], total_array[
                                                                                                      number_train_set:,
                                                                                                      :][:, -1]
